...
public class StackWithOperationOnMiddleNodeTesterGeneric
{
	public static void main(String args[])
	{
		try
		{
			SpecialStacks<Integer> newStack=new SpecialStacks<>();
			newStack.push(12);
			//it can be done due to autoboxing probably
			//due to autoboxing we need not to create a Integer
